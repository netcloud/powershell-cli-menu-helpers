...
BeforeAll -Scriptblock {
    ...
    [System.String]$TableTitle = 'Test table title'
...
Describe -Name "Test input parameters" {
    Context -Name " When no input parameters were provided" {
        It -Name " Should throw an error because of one or more missing mandatory parameters" {
            $err = { Select-ItemFromTable } |  Should -Throw -PassThru
            $err | Should -BeLike -ExpectedValue "Cannot process command because of one or more missing mandatory parameters: *."
        }
    }

    Context -Name " Check TableTitle input parameter" {
        It -Name " TableTitle ParameterType should be String" {
            (Get-Command -Name $FunctionName).Parameters.TableTitle.ParameterType.Name | Should -BeExactly -ExpectedValue 'String'
        }

        It -Name " Items IsMandatory should be true" {
            (Get-Command -Name $FunctionName).Parameters.TableTitle.ParameterSets.__AllParameterSets.IsMandatory | Should -Be $false
        }
    }
    ...
    Context -Name " Check HideTableHeaders input parameter" {
        It -Name " HideTableHeaders ParameterType should be SwitchParameter" {
            (Get-Command -Name $FunctionName).Parameters.HideTableHeaders.ParameterType.Name | Should -BeExactly -ExpectedValue 'SwitchParameter'
        }
    }
    ...
    Context -Name " When no option is enabled" {
        BeforeAll -Scriptblock {
            ...
            $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName
        }
    ...
    Context -Name " When MultiselectOption is enabled and AllowEmptyReturn disabled" {
        BeforeAll -Scriptblock {
            ...
            Mock -CommandName Write-Host -MockWith {}
            Mock -CommandName Clear-Host -MockWith {}
            $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName -MultiselectOption
        }
    ...
    Context -Name " When MultiselectOption and AllowEmptyReturn is enabled" {
        BeforeAll -Scriptblock {
            ...
            Mock -CommandName Write-Host -MockWith {}
            Mock -CommandName Clear-Host -MockWith {}
            $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName -MultiselectOption -AllowEmptyReturn
        }
    ...
    Context -Name " When CancelOption is enabled" {
        BeforeAll -Scriptblock {
            ...
            Mock -CommandName Write-Host -MockWith {}
            Mock -CommandName Clear-Host -MockWith {}
            $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName -CancelOption
        }
    ...
    Context -Name " When FilterOption is enabled" {
        BeforeAll -Scriptblock {
            ...
            Mock -CommandName Write-Host -MockWith {}
            Mock -CommandName Clear-Host -MockWith {}
            $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName -FilterOption
        }
    ...
    Context -Name " When AllowEmptyReturn is enabled" {
        BeforeAll -Scriptblock {
            ...
            Mock -CommandName Write-Host -MockWith {}
            Mock -CommandName Clear-Host -MockWith {}
            $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName -AllowEmptyReturn
        }
...
Describe -Name "Test the select item from table functions with only mandatory options and one selected item" {
    BeforeAll -Scriptblock {
        $global:counter = 0
        Mock -CommandName Read-Host -MockWith {
            $global:counter ++
        ...
        Mock -CommandName Write-Host -MockWith {}
        Mock -CommandName Clear-Host -MockWith {}
        $result = Select-ItemFromTable -Items $Items -PropertyName $PropertyName
    }

    It -Name " Table title should not be displayed" {
        Assert-MockCalled -CommandName Write-Host -Times 0 -Scope Describe -ParameterFilter { $Object -eq $TableTitle }
    }
...
Describe -Name "Test the select item from table functions with title, multiselect, filter and two selected items" {
    BeforeAll -Scriptblock {
        $global:counter = 0
        Mock -CommandName Read-Host -MockWith {
            $global:counter ++
        ...
        Mock -CommandName Write-Host -MockWith {}
        Mock -CommandName Clear-Host -MockWith {}
        $result = Select-ItemFromTable -TableTitle $TableTitle -Items $Items -PropertyName $PropertyName -MultiselectOption -FilterOption
    }

    It -Name " Table title should be displayed" {
        Assert-MockCalled -CommandName Write-Host -Times 1 -Scope Describe -ParameterFilter { $Object -eq $TableTitle }
    }

    It -Name " Table header should be displayed" {
        Assert-MockCalled -CommandName Write-Host -Times 1 -Scope Describe -ParameterFilter { $Object -eq '    Name  ' }
        Assert-MockCalled -CommandName Write-Host -Times 1 -Scope Describe -ParameterFilter { $Object -eq '--- ----  ' }
    }
...
Describe -Name "Test the select item from table functions with CancelOption and HideTableHeaders" {
    BeforeAll -Scriptblock {
        $global:counter = 0
        Mock -CommandName Read-Host -MockWith {
            $global:counter ++
        ...
        Mock -CommandName Write-Host -MockWith {}
        Mock -CommandName Clear-Host -MockWith {}
        $result = Select-ItemFromTable -Items $Items -PropertyName $PropertyName -CancelOption -HideTableHeaders
    }
    ...
    It -Name " Table header should not be displayed" {
        Assert-MockCalled -CommandName Write-Host -Times 0 -Scope Describe -ParameterFilter { $Object -eq '    Name  ' }
        Assert-MockCalled -CommandName Write-Host -Times 0 -Scope Describe -ParameterFilter { $Object -eq '--- ----  ' }
    }
...
Describe -Name "Test the select item from Table functions with AllowEmptyReturn" {
    BeforeAll -Scriptblock {
        $global:counter = 0
        Mock -CommandName Read-Host -MockWith {
            $global:counter ++
        ...
        Mock -CommandName Write-Host -MockWith {}
        Mock -CommandName Clear-Host -MockWith {}
        $result = Select-ItemFromTable -Items $Items -PropertyName $PropertyName -AllowEmptyReturn
    }
...
Describe -Name "Test the select item from table FilterOption with MultiselectOption" {
    BeforeAll -Scriptblock {
        $global:counter = 0
        Mock -CommandName Read-Host -MockWith {
            $global:counter ++
        ...
        Mock -CommandName Write-Host -MockWith {}
        Mock -CommandName Clear-Host -MockWith {}
        $result = Select-ItemFromTable -Items $Items -PropertyName $PropertyName -FilterOption -MultiselectOption
    }
